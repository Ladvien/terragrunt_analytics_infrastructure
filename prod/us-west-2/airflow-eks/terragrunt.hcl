...
inputs = {
    ...
    desired_number_of_ec2_instances = 3
    max_number_of_ec2_instances = 3
    ...
    fernet_key =  "AmZO0jf5S3C2L-N_KD57QTsMTWZ7yMiZUcKPFZhPNEQ="
    path_to_ssh_key             = "~/.ssh/workstation_key.pub"

    helm_values_file_path     = "/Users/ladvien/ladvien_terragrunt/prod/us-west-2/airflow-eks/marc_helm_values.yml"
    helm_values                =  yamldecode(file("/Users/ladvien/ladvien_terragrunt/prod/us-west-2/airflow-eks/marc_helm_values.yml"))
}
